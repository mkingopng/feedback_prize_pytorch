...
LABEL_ALL_SUBTOKENS = True  # mk: this is important
...
train_dataset = data.loc[data['id'].isin(IDS[train_idx]), ['text', 'entities']].reset_index(drop=True)  # mk: one part of the NER.csv is used for train_dataset
test_dataset = data.loc[data['id'].isin(IDS[valid_idx])].reset_index(drop=True)  # mk: the other part is used for the test dataset

print("FULL Dataset: {}".format(data.shape))
print("TRAIN Dataset: {}".format(train_dataset.shape))
print("TEST Dataset: {}".format(test_dataset.shape))

tokenizer = AutoTokenizer.from_pretrained(DOWNLOADED_MODEL_PATH)  # mk: this is using the pretrained tokenizer
