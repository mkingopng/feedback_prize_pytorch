...
def tokenize_for_validation(examples, tokenizer, label_to_index):
    """
...
def score_feedback_comp_micro(pred_df, ground_truth_df):
    """
...
def score_feedback_comp(pred_df, ground_truth_df, return_class_scores=False):
    """
